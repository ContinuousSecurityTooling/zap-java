...
public class AnalysisInfo {
	...
	public static class Builder {
		 ...
		 * <ul>
		 *     <li><b>WITH_SPIDER:</b><p> default analysis, which runs the Spider before runnning the Active Scan.</p></li>
	  	 *     <li><b>WITH_AJAX_SPIDER:</b><p> after running the default Spider, the AJAX Spider is executed before the Active Scan.
	 	 *                                  This is useful for applications that rely on AJAX.</p></li>
	 	 *     <li><b>ACTIVE_SCAN_ONLY:</b><p> no Spider is executed before the Active Scan. This is useful in case the application
	 	 *                                  navigation is done via proxy (proxied Selenium tests, for instance).</p></li>
	 	 *     <li><b>SPIDER_ONLY:</b><p> no Active Scan is executed after the Spider. This is useful when on wants to run the
	 	 *                                   passive scan only.</p></li>
	 	 *     <li><b>SPIDER_AND_AJAX_SPIDER_ONLY:</b><p> Just like the previous, but including the AJAX Spider.</p></li>
	 	 * </ul>
		 * @return this {@code Builder} instance.
		 */
